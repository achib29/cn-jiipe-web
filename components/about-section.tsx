...
const defaults: Record<string, { en: string; cn: string }> = {
  ...
  video_url: { en: 'https://youtu.be/9fHxvXcmoqY', cn: 'https://youtu.be/9fHxvXcmoqY' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="aspect-video overflow-hidden rounded-lg shadow-xl relative group">
              ...
              <a href={videoLink} target="_blank" rel="noopener noreferrer" className="absolute inset-0 flex items-center justify-center z-20 group/play cursor-pointer">
              ...
              <a href={videoLink} target="_blank" rel="noopener noreferrer" className="hidden md:inline-flex absolute bottom-5 left-5 z-30 group/capsule">
