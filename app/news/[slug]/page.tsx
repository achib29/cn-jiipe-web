        ...
        <div className="mt-12 mb-12 p-8 md:p-12 bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl shadow-2xl border border-gray-700/50 relative overflow-hidden group">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              Discover world-class infrastructure and strategic investment
              opportunities in Indonesia&apos;s first integrated industrial
              estate.
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
              <div>
                ...
                <p className="text-gray-500 mt-2">
                  Discover more stories from JIIPE
                </p>
              </div>
              <Link
                href="/news"
                className="text-red-600 font-bold hover:text-red-700 flex items-center gap-1 group"
              >
                View All Articles{" "}
                <ArrowRight
                  size={18}
